...
// Resolve the JSON path relative to this script file to avoid 404s
const currentScript = document.currentScript || document.querySelector('script[src$="nodeLink.js"]');
const scriptBase = currentScript && currentScript.src ? currentScript.src.replace(/\/[^\/]*$/, '/') : './';

d3.json(scriptBase + 'nodeLink.json')
    .then(nodeLink => {
